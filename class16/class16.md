...
```
    ...
    ## Info: Working in directory /Users/katherinemwong/Desktop/bimm143/bimm143_github/class16
...
![](hsa04330.pathview.png) &gt; Q7. Can you do the same procedure as
above to plot the pathview figures for the top 5 down-reguled pathways?
...
The significant pathways listed do not match my previous KEGG
results.The differences could be caused by how KEGG uses gene
annotations from ENTREZ IDs, and Reactome Analysis looks for significant
genes based on p-value.
...
platelet-derived growth factor receptor signaling pathway. Not similar
to KEGG results. Not sure what could cause the difference.
