...
Endosomal/Vacuolar Pathway has the most significant "Entities p-value". The significant pathways listed do not match my previous KEGG results.The differences could be caused by how KEGG uses gene annotations from ENTREZ IDs, and Reactome Analysis looks for significant genes based on p-value.
...
platelet-derived growth factor receptor signaling pathway. Not similar to KEGG results. Not sure what could cause the difference.